import * as mappers from '../../../src/ChainHistory/DbSyncChainHistoryProvider/mappers';
...
import {
  ...
  WithCertType,
  WithdrawalModel
} from '../../../src/ChainHistory/DbSyncChainHistoryProvider/types';
  ...
  describe('mapCertificate', () => {
    ...
    test('map PoolUpdateCertModel to Cardano.PoolRegistrationCertificate', () => {
      const result = mappers.mapCertificate({
        ...
        pool_id: poolId,
        type: 'update'
      } as WithCertType<PoolUpdateCertModel>);
